...
#ifndef __fann_avx_h__
#define __fann_avx_h__
#include "fann.h"

#if (defined FLOATFANN || defined DOUBLEFANN) && defined FANN_USE_AVX

/* Function: fann_run_avx
	...
	Does the same as fann_run but uses AVX instructions
...
/*  Function: fann_can_use_avx
	...
	and number of neurons in input and hidden layers including bias neurons must be multiply of 8.
