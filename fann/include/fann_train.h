...
/* Function: fann_train_sse

   Train one iteration with a set of inputs, and a set of desired outputs.
   This training is always incremental training (see <fann_train_enum>), since
   only one pattern is presented.
   This function uses SSE SIMD instructions
...
/* Function: fann_train_avx

   Train one iteration with a set of inputs, and a set of desired outputs.
   This training is always incremental training (see <fann_train_enum>), since
   only one pattern is presented.
   This function uses AVX SIMD instructions
...
/* Function: fann_get_activation_function
   ...
   This function appears in FANN >= 2.1.0
 */ 
FANN_EXTERNAL enum fann_activationfunc_enum FANN_API fann_get_activation_function(struct fann *ann,	int layer);
