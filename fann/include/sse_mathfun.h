...
//__inline __m128  __fastcall _mm_castsi128_ps(__m128i n) { return *(__m128 *) &n; } 
//__inline __m128i __fastcall _mm_castps_si128(__m128 n) { return *(__m128i*) &n; }
...
/* natural logarithm computed for 4 simultaneous float 
   return NaN for x <= 0
*/
__inline __m128 __fastcall log_ps(__m128 x) {
#ifdef FM_USE_SSE2
  __m128i emm0;
#else
  __m64 mm0, mm1;
...
__inline __m128 __fastcall exp_ps(__m128 x) {
...
/* evaluation of 4 sines at onces, using only SSE1+MMX intrinsics so
   ...
   deliver full speed.
*/
__inline __m128 __fastcall sin_ps(__m128 x) { // any x
...
__inline __m128 __fastcall cos_ps(__m128 x) { // any x
...
__inline void __fastcall sincos_ps(__m128 x, __m128 *s, __m128 *c) {
